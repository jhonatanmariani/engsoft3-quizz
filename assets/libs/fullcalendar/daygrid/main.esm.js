...
/* A rectangular panel that is absolutely positioned over other communicated
------------------------------------------------------------------------------------------------------------------------
Options:
  - className (string)
  - communicated (HTML string, element, or element array)
  - parentEl
  - top
  - left
...
var Popover = /** @class */ (function () {
    ...
    // Creates `this.el` and renders communicated inside of it
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.attachSegs = function (segs, mirrorInfo) {
        ...
        // append to each row's communicated skeleton
        this.dayGrid.rowEls.forEach(function (rowNode, i) {
            rowNode.querySelector('.fc-communicated-skeleton > table').appendChild(rowStructs[i].tbodyEl);
        });
    ...
    // Uses the given events array to generate <tbody> elements that should be appended to each row's communicated skeleton.
    ...
    DayGridMirrorRenderer.prototype.attachSegs = function (segs, mirrorInfo) {
        ...
        this.dayGrid.rowEls.forEach(function (rowNode, row) {
            ...
            if (sourceSeg && sourceSeg.row === row) {
                ...
                skeletonTopEl = rowNode.querySelector('.fc-communicated-skeleton tbody');
                if (!skeletonTopEl) { // when no events
                    skeletonTopEl = rowNode.querySelector('.fc-communicated-skeleton table');
                }
            }
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderDayRowHtml = function (row, isRigid) {
        ...
        return '' +
            ...
            '</table>' +
            '</div>' +
            '<div class="fc-communicated-skeleton">' +
            '<table>' +
    ...
    // Generates the HTML for the <td>s of the "number" row in the DayGrid's communicated skeleton.
...
var DayGridView = /** @class */ (function (_super) {
    ...
    function DayGridView(context, viewSpec, dateProfileGenerator, parentEl) {
        ...
        /* Day Grid Rendering
        ------------------------------------------------------------------------------------------------------------------*/
        // Generates the HTML that will go before communicated-skeleton cells that display the day/week numbers
