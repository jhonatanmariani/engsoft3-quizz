...
(function (global, factory) {
    ...
    */
    ...
    var TimeGrid = /** @class */ (function (_super) {
        ...
        /* Content Skeleton
        ------------------------------------------------------------------------------------------------------------------*/
        // Renders the DOM that the view's communicated will live in
        TimeGrid.prototype.renderContentSkeleton = function () {
            ...
            skeletonEl = this.contentSkeletonEl = core.htmlToElement('<div class="fc-communicated-skeleton">' +
                '<table>' +
                '<tr>' + parts.join('') + '</tr>' +
                '</table>' +
                '</div>');
            this.colContainerEls = core.findElements(skeletonEl, '.fc-communicated-col');
    ...
    var TimeGridView = /** @class */ (function (_super) {
        ...
        function TimeGridView(context, viewSpec, dateProfileGenerator, parentEl) {
            ...
            // Affects communicated-skeleton, mirror-skeleton, highlight-skeleton for both the time-grid and day-grid.
